    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlayProgresses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PlayProgresses_Episodes_EpisodeId",
                        column: x => x.EpisodeId,
                        principalTable: "Episodes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PlayProgresses_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Episodes_PodcastId_EpisodeNumber_SeasonNumber",
                table: "Episodes",
                columns: new[] { "PodcastId", "EpisodeNumber", "SeasonNumber" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlayProgresses_EpisodeId",
                table: "PlayProgresses",
                column: "EpisodeId");

            migrationBuilder.CreateIndex(
                name: "IX_PlayProgresses_UserId_EpisodeId",
                table: "PlayProgresses",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Subscriptions_UserId_PodcastId",
                table: "Subscriptions",
